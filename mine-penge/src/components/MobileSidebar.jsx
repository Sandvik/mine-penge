...
function MobileSidebar({ 
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div 
        className={`mobile-sidebar fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-nordic-50 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
